...
public class ViewAnimator<T extends Resourceble> {
        ...
        for (int i = 0; i < size; i++) {
            ...
            viewMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Toast.makeText(v.getContext(),String.valueOf(finalI),Toast.LENGTH_LONG).show(); 
    ...
    private void switchItem(Resourceble slideMenuItem, int topPosition,int finalI) {
        this.screenShotable = animatorListener.onSwitch(slideMenuItem, screenShotable, topPosition,finalI);
        hideMenuContent();
    }

    public interface ViewAnimatorListener {

        public ScreenShotable onSwitch(Resourceble slideMenuItem, ScreenShotable screenShotable, int position, int fianlI);
