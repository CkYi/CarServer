package yalantis.com.sidemenu.weizhang;

import java.util.ArrayList;
import java.util.List;

import yalantis.com.sidemenu.adapter.WeiZhangListAdapter;
...
public class WeiZhangCityList extends Activity {
	private ListView lv_list;
	private WeiZhangListAdapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.weizhang_activity_citys);
		...
		mAdapter = new WeiZhangListAdapter(this, getData(provinceId));
	 ...
	 * @return
	 */
	private List<WeiZhangListModel> getData(String provinceId) {
		List<WeiZhangListModel> list = new ArrayList<WeiZhangListModel>();
		...
		for (CityInfoJson cityInfoJson : cityList) {
			...
			WeiZhangListModel model = new WeiZhangListModel();
