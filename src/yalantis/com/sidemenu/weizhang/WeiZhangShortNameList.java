...
public class WeiZhangShortNameList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.weizhang_activity_shortname);
		...
		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				R.layout.weizhang_listitem_shortname, getData());
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(txt.length()>0){
					Toast.makeText(WeiZhangShortNameList.this, txt, 0).show();
