...
public class DashboardView extends View {
	...
	public DashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mMaxValue = a.getInteger(R.styleable.DashboardView_maxValue, 10);
	...
	private void drawCircleAndReadingText(Canvas canvas) {
		...
		// ���ƶ���
		canvas.drawText(trimFloat(mRealTimeValue)+postfix, mCenterX, mCenterY
	...
	public float[] getCoordinatePoint(int radius, float cirAngle) {
		...
		double arcAngle = Math.toRadians(cirAngle); // ���Ƕ�ת��Ϊ����
		if (cirAngle < 90) {
